...
* Windows 10
  ...
  1. Перейдите на офицальный сайт Python, в раздел скачивания [this link](https://www.python.org/downloads/), скачайте и установите python 3.
...
Откройте [Issues](https://github.com/github_username/repo_name/issues) получите список будующих функций проекта.
